    ...
    public void onClick(View v) {
        switch(v.getId()) {
            ...
            case R.id.setting_eng_read_overlap_layout:
                if(!mIsEngExpanding) {
                    mLayoutEngExpanding.startAnimation(slideDownEng);
                    mLayoutEngExpanding.setVisibility(View.VISIBLE);
                }
                else {
                    mLayoutEngExpanding.startAnimation(slideUpEng);
                }
                mIsEngExpanding = !mIsEngExpanding;
                break;
            case R.id.setting_emotion_overlap_layout:
                if(!mIsEmotionExpanding) {
                    mLayoutEmotionExpanding.startAnimation(slideDownEmotion);
                    mLayoutEmotionExpanding.setVisibility(View.VISIBLE);
                }
                else {
                    mLayoutEmotionExpanding.startAnimation(slideUpEmotion);
                }
